...
public interface IUsuarioService
{
    ...
    Task<UsuarioResponseDto?> GetPerfilAsync(CancellationToken cancellationToken = default);
    ...
    Task<UsuarioResponseDto?> UpdatePerfilAsync(UsuarioPerfilUpdateDto dto, CancellationToken cancellationToken = default);
